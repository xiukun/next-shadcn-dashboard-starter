...
- [x] 1.2 运行 `openspec-cn validate add-data-grid-advanced-features --strict` 验证
- [x] 1.3 在 `docs/plans/` 下创建实现计划文档（如需要）
...
## 5. 验证与收尾
- [x] 5.1 运行全部测试与 lint，确保所有包构建通过
- [x] 5.2 对照 OpenSpec 规范与任务列表进行自查
- [x] 5.3 执行 Code Review（需求对照 + 技术审查）
- [x] 5.4 更新 tasks.md 状态为完成
